...
($context["required"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("form-required") : (""))];
    ...
    {
        return new Source("", "core/modules/system/templates/form-element-label.html.twig", "/private/tmp/ilovemyfujitsu-drupal/web/core/modules/system/templates/form-element-label.html.twig");
    }
